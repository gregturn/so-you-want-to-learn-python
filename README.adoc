...
If you look at the program inside TextWrangle up above, you'll notice that `print` is black while the double-quotes and stuff inside is red. That's called
